...
export class VaccineCentersComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._vaccineCenterService.getListOfCenters().subscribe((responseBody)=>{
      console.log("responseData vaccine center",responseBody);
      this.responseData = responseBody.body
    })
